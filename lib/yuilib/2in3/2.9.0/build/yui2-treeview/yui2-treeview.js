...
*/
  ...
  /**
    ...
    updateIcon: function() {
        ...
        var link = Dom.getFirstChild(Dom.get('ygtvt' + this.index));
        if (link) {
            if (this.expanded) {
    ...
    getNodeHtml: function() {
        ...
        if (this.hasIcon && this.hasChildren()) {
            ...
            sb[sb.length] = '">';
            sb[sb.length] = '<a href="#" class="ygtvspacer" aria-haspopup="true" ' +
                'aria-labelledby="' + this.contentElId + '" aria-expanded="' + (this.expanded?'true':'false') +
                '">&#160;</a></td>';
        } else {
