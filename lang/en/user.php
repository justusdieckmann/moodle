...
$string['privacy:browserspath'] = 'User browsers';
...
$string['privacy:metadata:browsertablesummary'] = 'This table stores information about browsers where the user logged in, in order be able to send new login mails.';
$string['privacy:metadata:browsertoken'] = 'Random token also stored in the browser to verify the browsers identity.';
...
$string['privacy:metadata:lastuseragent'] = 'The last user agent the user logged in with in this browser. It will be used for better security.';
